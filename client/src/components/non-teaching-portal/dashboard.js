...
class NonTeachingDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            staffDetails: [],
    ...
    */
    fetchStaffDetails() {
        ...
        if (userID) {
            axios.get(`/xakal/nonteaching/${userID.userID}`)
                .then((response) => {
    ...
    updateDetails() {
        ...
        axios.put(`/xakal/nonteaching/update/${this.state.staffDetails._id}`, params)
            .then(() => {
                if (!isUpdated) {
                    ...
                    <div className="col-xl-4 col-md-6 mb-4">
                        <div className="card border-left-primary shadow h-100 py-2">
                            <div className="card-body">
                                <div className="row no-gutters align-items-center">
                                    <div className="col mr-2">
                                        <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">Performance rating</div>
