...
class WorkersDetailsMaintain extends Component {
    constructor(props) {
        super(props);
        this.state = {
            staffDetails: [],
    ...
    updateDetails() {
        ...
        if (this.state.isEdit && this.staffArray && this.staffArray.length) {
            this.staffArray.forEach(element => {
                ...
                axios.put(`/xakal/nonteaching/update/${element._id}`, params)
                    .then(() => {
                        if (!isUpdated) {
            ...
            this.deleteArray.forEach(element => {
                axios.delete(`/xakal/nonteaching/${element._id}`)
                    .then(() => {
                        if (!isUpdated) {
...
export default WorkersDetailsMaintain;